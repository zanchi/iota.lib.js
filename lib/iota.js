...
iota.api.prepareTransfers('ABCD', [
    {
        'address': 'NPMYNOLFWYWKIXBOYLXZKZNCZDUEMBDGLXHJRUV9EUEOONUQDAJPBAUGTYKOPZCGMFMUPGHITNUBQ9VGL',
        'value': new BN('221713244121518884974124815309574946401')
    }
],
{
    'inputs': [{
        'address': 'KUX9T9QOQKBKBBSQVIH9OGSHXHJSLKUHSSOELEWFEGKIPQXUDEFR9AGJOQVCYIYKCZ9ONPHTOWKVNWYUS',
        'security': 3,
        'keyIndex': 0
    }]
}
